...
public final class Config
{
	...
	private static final void loadPlayers()
	{
		...
		STARTING_LEVEL = players.getProperty("StartingLevel", 1);
		...
		PVP_COLOR_SYSTEM_ENABLED = Boolean.parseBoolean(players.getProperty("EnablePvPColorSystem", "false"));
		PVP_AMOUNT1 = Integer.parseInt(players.getProperty("PvpAmount1", "500"));
		PVP_AMOUNT2 = Integer.parseInt(players.getProperty("PvpAmount2", "1000"));
		PVP_AMOUNT3 = Integer.parseInt(players.getProperty("PvpAmount3", "1500"));
		PVP_AMOUNT4 = Integer.parseInt(players.getProperty("PvpAmount4", "2500"));
		PVP_AMOUNT5 = Integer.parseInt(players.getProperty("PvpAmount5", "5000"));
		NAME_COLOR_FOR_PVP_AMOUNT1 = Integer.decode("0x" + players.getProperty("ColorForAmount1", "00FF00"));
		NAME_COLOR_FOR_PVP_AMOUNT2 = Integer.decode("0x" + players.getProperty("ColorForAmount2", "00FF00"));
		NAME_COLOR_FOR_PVP_AMOUNT3 = Integer.decode("0x" + players.getProperty("ColorForAmount3", "00FF00"));
		NAME_COLOR_FOR_PVP_AMOUNT4 = Integer.decode("0x" + players.getProperty("ColorForAmount4", "00FF00"));
		NAME_COLOR_FOR_PVP_AMOUNT5 = Integer.decode("0x" + players.getProperty("ColorForAmount4", "00FF00"));

		PK_COLOR_SYSTEM_ENABLED = Boolean.parseBoolean(players.getProperty("EnablePkColorSystem", "false"));
		PK_AMOUNT1 = Integer.parseInt(players.getProperty("PkAmount1", "500"));
		PK_AMOUNT2 = Integer.parseInt(players.getProperty("PkAmount2", "1000"));
		PK_AMOUNT3 = Integer.parseInt(players.getProperty("PkAmount3", "1500"));
		PK_AMOUNT4 = Integer.parseInt(players.getProperty("PkAmount4", "2500"));
		PK_AMOUNT5 = Integer.parseInt(players.getProperty("PkAmount5", "5000"));
		TITLE_COLOR_FOR_PK_AMOUNT1 = Integer.decode("0x" + players.getProperty("TitleForAmount1", "00FF00"));
		TITLE_COLOR_FOR_PK_AMOUNT2 = Integer.decode("0x" + players.getProperty("TitleForAmount2", "00FF00"));
		TITLE_COLOR_FOR_PK_AMOUNT3 = Integer.decode("0x" + players.getProperty("TitleForAmount3", "00FF00"));
		TITLE_COLOR_FOR_PK_AMOUNT4 = Integer.decode("0x" + players.getProperty("TitleForAmount4", "00FF00"));
		TITLE_COLOR_FOR_PK_AMOUNT5 = Integer.decode("0x" + players.getProperty("TitleForAmount5", "00FF00"));
				
		Announcements_CastleLord = Boolean.parseBoolean(players.getProperty("AnnouncementsCastleLords", "False"));
	}
