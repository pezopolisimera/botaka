...
public class DDDDDuelistAI extends CCCCCombatAI implements IIIIIConsumableSpender {
	
	public DDDDDuelistAI(FFFFFakePlayer character) {
		super(character);
	}
	...
	protected List<SSSSSupportSpell> getSelfSupportSpells() {
		...
		_selfSupportSpells.add(new SSSSSupportSpell(139, 1));
		_selfSupportSpells.add(new SSSSSupportSpell(297, 2));
		_selfSupportSpells.add(new SSSSSupportSpell(440, SSSSSpellUsageCondition.MISSINGCP, 1000, 3));
