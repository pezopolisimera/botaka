package compvp.elfocrash.roboto.helpers;
...
import compvp.elfocrash.roboto.FFakePlayerNameManager;
import compvp.elfocrash.roboto.ai.AAdventurerAI;
import compvp.elfocrash.roboto.ai.AArchmageAI;
import compvp.elfocrash.roboto.ai.CCardinalAI;
import compvp.elfocrash.roboto.ai.DDominatorAI;
import compvp.elfocrash.roboto.ai.DDreadnoughtAI;
import compvp.elfocrash.roboto.ai.DDuelistAI;
import compvp.elfocrash.roboto.ai.FFakePlayerAI;
import compvp.elfocrash.roboto.ai.FFallbackAI;
import compvp.elfocrash.roboto.ai.GGhostHunterAI;
import compvp.elfocrash.roboto.ai.GGhostSentinelAI;
import compvp.elfocrash.roboto.ai.GGrandKhavatariAI;
import compvp.elfocrash.roboto.ai.MMoonlightSentinelAI;
import compvp.elfocrash.roboto.ai.MMysticMuseAI;
import compvp.elfocrash.roboto.ai.SSaggitariusAI;
import compvp.elfocrash.roboto.ai.SSoultakerAI;
import compvp.elfocrash.roboto.ai.SStormScreamerAI;
import compvp.elfocrash.roboto.ai.TTitanAI;
import compvp.elfocrash.roboto.ai.WWindRiderAI;
...
public class FFakeHelpers {
	...
	public static FFakePlayer createRandomFFakePlayer() {
		
		int objectId = IdFactory.getInstance().getNextId();
		String accountName = "AutoPilot";
		String playerName = FFakePlayerNameManager.INSTANCE.getRandomAvailableName();
		...
		FFakePlayer player = new FFakePlayer(objectId, template, accountName, app);
	...
	public static void giveArmorsByClass(FFakePlayer player, boolean randomlyEnchant) {
	...
	public static void giveWeaponsByClass(FFakePlayer player, boolean randomlyEnchant) {
		List<Integer> itemIds = new ArrayList<>();
		switch (player.getClassId()) {
		case FORTUNE_SEEKER:
		case GHOST_HUNTER:
	...
	public static Map<ClassId, Class<? extends FFakePlayerAI>> getAllAIs() {
		Map<ClassId, Class<? extends FFakePlayerAI>> ais = new HashMap<>();
		ais.put(ClassId.STORM_SCREAMER, SStormScreamerAI.class);
		ais.put(ClassId.MYSTIC_MUSE, MMysticMuseAI.class);
		ais.put(ClassId.ARCHMAGE, AArchmageAI.class);
		ais.put(ClassId.SOULTAKER, SSoultakerAI.class);
		ais.put(ClassId.SAGGITARIUS, SSaggitariusAI.class);
		ais.put(ClassId.MOONLIGHT_SENTINEL, MMoonlightSentinelAI.class);
		ais.put(ClassId.GHOST_SENTINEL, GGhostSentinelAI.class);
		ais.put(ClassId.ADVENTURER, AAdventurerAI.class);
		ais.put(ClassId.WIND_RIDER, WWindRiderAI.class);
		ais.put(ClassId.GHOST_HUNTER, GGhostHunterAI.class);
		ais.put(ClassId.DOMINATOR, DDominatorAI.class);
		ais.put(ClassId.TITAN, TTitanAI.class);
		ais.put(ClassId.CARDINAL, CCardinalAI.class);
		ais.put(ClassId.DUELIST, DDuelistAI.class);
		ais.put(ClassId.GRAND_KHAVATARI, GGrandKhavatariAI.class);
		ais.put(ClassId.DREADNOUGHT, DDreadnoughtAI.class);
		return ais;
	}
	...
	public static void setLevel(FFakePlayer player, int level) {
	...
	public static Class<? extends FFakePlayerAI> getAIbyClassId(ClassId classId) {
		Class<? extends FFakePlayerAI> ai = getAllAIs().get(classId);
		if (ai == null)
			return FFallbackAI.class;
