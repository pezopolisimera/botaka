 ...
 *
 */
public class MMysticMuseAI extends CCombatAI
{
	public MMysticMuseAI(FFakePlayer character)
	{
		super(character);		
	}
	...
	protected List<OOffensiveSpell> getOffensiveSpells()
	{
		...
		_offensiveSpells.add(new OOffensiveSpell(1235, 4));
		_offensiveSpells.add(new OOffensiveSpell(1340, 3));
		_offensiveSpells.add(new OOffensiveSpell(1342, 2));
		_offensiveSpells.add(new OOffensiveSpell(1265, 1));	
