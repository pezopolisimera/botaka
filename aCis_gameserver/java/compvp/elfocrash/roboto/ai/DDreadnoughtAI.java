...
public class DDreadnoughtAI extends CCombatAI implements IIConsumableSpender {
	
	public DDreadnoughtAI(FFakePlayer character) {
		super(character);
	}
	...
	protected List<SSupportSpell> getSelfSupportSpells() {
		...
		_selfSupportSpells.add(new SSupportSpell(440, SSpellUsageCondition.MISSINGCP, 1000, 1));
