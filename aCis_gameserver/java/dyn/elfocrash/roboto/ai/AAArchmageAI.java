 ...
 *
 */
public class AAArchmageAI extends CCCombatAI
{
	public AAArchmageAI(FFFakePlayer character)
	{
		super(character);		
	}
	...
	protected List<OOOffensiveSpell> getOffensiveSpells()
	{
		...
		_offensiveSpells.add(new OOOffensiveSpell(1230, 1));
		_offensiveSpells.add(new OOOffensiveSpell(1339, 1));	
