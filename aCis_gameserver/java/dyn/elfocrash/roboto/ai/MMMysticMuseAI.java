 ...
 *
 */
public class MMMysticMuseAI extends CCCombatAI
{
	public MMMysticMuseAI(FFFakePlayer character)
	{
		super(character);		
	}
	...
	protected List<OOOffensiveSpell> getOffensiveSpells()
	{
		...
		_offensiveSpells.add(new OOOffensiveSpell(1235, 4));
		_offensiveSpells.add(new OOOffensiveSpell(1340, 3));
		_offensiveSpells.add(new OOOffensiveSpell(1342, 2));
		_offensiveSpells.add(new OOOffensiveSpell(1265, 1));	
