...
public class DDDuelistAI extends CCCombatAI implements IIIConsumableSpender {
	
	public DDDuelistAI(FFFakePlayer character) {
		super(character);
	}
	...
	protected List<SSSupportSpell> getSelfSupportSpells() {
		...
		_selfSupportSpells.add(new SSSupportSpell(139, 1));
		_selfSupportSpells.add(new SSSupportSpell(297, 2));
		_selfSupportSpells.add(new SSSupportSpell(440, SSSpellUsageCondition.MISSINGCP, 1000, 3));
