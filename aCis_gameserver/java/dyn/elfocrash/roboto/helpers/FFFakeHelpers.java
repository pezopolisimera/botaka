package dyn.elfocrash.roboto.helpers;
...
import dyn.elfocrash.roboto.FFFakePlayerNameManager;
import dyn.elfocrash.roboto.ai.AAAdventurerAI;
import dyn.elfocrash.roboto.ai.AAArchmageAI;
import dyn.elfocrash.roboto.ai.CCCardinalAI;
import dyn.elfocrash.roboto.ai.DDDominatorAI;
import dyn.elfocrash.roboto.ai.DDDreadnoughtAI;
import dyn.elfocrash.roboto.ai.DDDuelistAI;
import dyn.elfocrash.roboto.ai.FFFakePlayerAI;
import dyn.elfocrash.roboto.ai.FFFallbackAI;
import dyn.elfocrash.roboto.ai.GGGhostHunterAI;
import dyn.elfocrash.roboto.ai.GGGhostSentinelAI;
import dyn.elfocrash.roboto.ai.GGGrandKhavatariAI;
import dyn.elfocrash.roboto.ai.MMMoonlightSentinelAI;
import dyn.elfocrash.roboto.ai.MMMysticMuseAI;
import dyn.elfocrash.roboto.ai.SSSaggitariusAI;
import dyn.elfocrash.roboto.ai.SSSoultakerAI;
import dyn.elfocrash.roboto.ai.SSStormScreamerAI;
import dyn.elfocrash.roboto.ai.TTTitanAI;
import dyn.elfocrash.roboto.ai.WWWindRiderAI;
...
public class FFFakeHelpers {
	...
	public static FFFakePlayer createRandomFFFakePlayer() {
		
		int objectId = IdFactory.getInstance().getNextId();
		String accountName = "AutoPilot";
		String playerName = FFFakePlayerNameManager.INSTANCE.getRandomAvailableName();
		...
		FFFakePlayer player = new FFFakePlayer(objectId, template, accountName, app);
	...
	public static void giveArmorsByClass(FFFakePlayer player, boolean randomlyEnchant) {
	...
	public static void giveWeaponsByClass(FFFakePlayer player, boolean randomlyEnchant) {
		List<Integer> itemIds = new ArrayList<>();
		switch (player.getClassId()) {
		case FORTUNE_SEEKER:
		case GHOST_HUNTER:
	...
	public static Map<ClassId, Class<? extends FFFakePlayerAI>> getAllAIs() {
		Map<ClassId, Class<? extends FFFakePlayerAI>> ais = new HashMap<>();
		ais.put(ClassId.STORM_SCREAMER, SSStormScreamerAI.class);
		ais.put(ClassId.MYSTIC_MUSE, MMMysticMuseAI.class);
		ais.put(ClassId.ARCHMAGE, AAArchmageAI.class);
		ais.put(ClassId.SOULTAKER, SSSoultakerAI.class);
		ais.put(ClassId.SAGGITARIUS, SSSaggitariusAI.class);
		ais.put(ClassId.MOONLIGHT_SENTINEL, MMMoonlightSentinelAI.class);
		ais.put(ClassId.GHOST_SENTINEL, GGGhostSentinelAI.class);
		ais.put(ClassId.ADVENTURER, AAAdventurerAI.class);
		ais.put(ClassId.WIND_RIDER, WWWindRiderAI.class);
		ais.put(ClassId.GHOST_HUNTER, GGGhostHunterAI.class);
		ais.put(ClassId.DOMINATOR, DDDominatorAI.class);
		ais.put(ClassId.TITAN, TTTitanAI.class);
		ais.put(ClassId.CARDINAL, CCCardinalAI.class);
		ais.put(ClassId.DUELIST, DDDuelistAI.class);
		ais.put(ClassId.GRAND_KHAVATARI, GGGrandKhavatariAI.class);
		ais.put(ClassId.DREADNOUGHT, DDDreadnoughtAI.class);
		return ais;
	}
	...
	public static void setLevel(FFFakePlayer player, int level) {
	...
	public static Class<? extends FFFakePlayerAI> getAIbyClassId(ClassId classId) {
		Class<? extends FFFakePlayerAI> ai = getAllAIs().get(classId);
		if (ai == null)
			return FFFallbackAI.class;
