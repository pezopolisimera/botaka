...
public class GGGGrandKhavatariAI extends CCCCombatAI {
    ...
    public void thinkAndAct() {
        ...
        // 0. Παρέμβαση υπέρ ally/clan που δέχεται επίθεση από hostile
        ...
        // 1. Auto-defend μόνο σε hostile flagged/Karma παίκτες — exclude admins & allies
        ...
        // 2. Αν υπάρχει ενεργό target, συνέχισε ΜΟΝΟ αν είναι ακόμα hostile
        if (_inAutoDefend) {
