...
public class DDDDuelistAI extends CCCCombatAI implements IIIIConsumableSpender {
	...
	protected List<SSSSupportSpell> getSelfSupportSpells() {
		...
		_selfSupportSpells.add(new SSSSupportSpell(139, 1));
		_selfSupportSpells.add(new SSSSupportSpell(297, 2));
		_selfSupportSpells.add(new SSSSupportSpell(440, SSSSpellUsageCondition.MISSINGCP, 1000, 3));
