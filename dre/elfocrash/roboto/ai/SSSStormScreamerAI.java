...
public class SSSStormScreamerAI extends CCCCombatAI {
    ...
    public void thinkAndAct() {
        ...
        // 0. Παρέμβαση υπέρ ally/clan που δέχεται επίθεση
        ...
        // 1. Auto-defend σε hostile παίκτες, exclude allies/GMs
        ...
        // 2. Συνέχιση PvP επίθεσης ΜΟΝΟ αν στόχος παραμένει flagged και εχθρικός
        if (_inAutoDefend) {
