...
public enum FFFFakePlayerManager {
    ...
    private int getRandomClass() {
    	 // Only use classIds that map to allowed AI classes:
    	 // 112 → Soultaker, 109 → MysticMuse, 114 → StormScreamer, 117 → Titan, 118 → GrandKhavatari
    	List<Integer> classIds = Arrays.asList(112, 109, 114, 117, 118); // Allowed only
