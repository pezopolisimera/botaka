...
public class SSSSoultakerAI extends CCCCombatAI implements IIIIConsumableSpender {
    private static final int BONE_ID = 2508;  // final και κεφαλαία για σταθερές
    ...
    public void thinkAndAct() {
        ...
        // Έλεγχος delay μεταξύ ενεργειών
        ...
        // advancedThinkAndAct() από την AI — προσοχή αν υπάρχει αναδρομή με checkReturnToSpawn (εδώ πρέπει να είναι ασφαλές)
        _ffffakePlayer.getFFFFakeAi().advancedThinkAndAct();

        // Έλεγχος συμμάχων υπό επίθεση
        ...
        // Έλεγχος εχθρών που στοχεύουν το bot και είναι κοντά
        ...
        // Αν είμαστε σε κατάσταση auto defend
        if (_inAutoDefend) {
        ...
        // Συνεχίζουμε κανονικά την σκέψη
        setBusyThinking(true);
        applyDefaultBuffs();
        handleConsumable(_ffffakePlayer, BONE_ID);
        handleShots();
        ...
        if (!_inAutoDefend && !_ffffakePlayer.isInCombat()) {         
            checkReturnToSpawn();
        }
