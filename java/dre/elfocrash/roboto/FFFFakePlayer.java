...
public class FFFFakePlayer extends Player
{
	...
	public String getDisplayName() {
	    return _customName != null ? _customName : getName();
	}
	...
	public void setLastPrivateMessage(String senderName, String messageText) {
	    ...
	    /**
	     * Proxy ΞΌΞ­ΞΈΞΏΞ΄ΞΏΟ‚ Ξ³ΞΉΞ± Ξ±ΟƒΟ†Ξ±Ξ»Ξ® ΞΊΞ»Ξ®ΟƒΞ· Ο€ΟΞΏΟ‚ Ο„ΞΏ AI ΟΟ„Ξ±Ξ½ Ξ΄Ξ­Ο‡ΞµΟ„Ξ±ΞΉ ΞµΟ€Ξ―ΞΈΞµΟƒΞ·.
	    */
	    public void handleAttackBy(Player attacker) {
	       if (getFFFFakeAi() != null) {
	            getFFFFakeAi().onAttackedBy(attacker);
	        }
	    }				
	...
	public boolean canCast(L2Skill skill, WorldObject target) {
	    if (skill == null || isSkillDisabled(skill))
	        return false;
	
	    if (isCastingNow() || isFakeDeath() || isOutOfControl() || isDead())
	        return false;
	
	    // Ξ§ΟΞ®ΟƒΞ· Ο„Ξ·Ο‚ Ο…Ο€Ξ¬ΟΟ‡ΞΏΟ…ΟƒΞ±Ο‚ Ξ»ΞΏΞ³ΞΉΞΊΞ®Ο‚ cast
