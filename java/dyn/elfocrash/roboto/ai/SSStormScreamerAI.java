 ...
 *
 */
public class SSStormScreamerAI extends CCCombatAI
{
	public SSStormScreamerAI(FFFakePlayer character)
	{
		super(character);		
	}
	...
	protected List<OOOffensiveSpell> getOffensiveSpells()
	{
		...
		_offensiveSpells.add(new OOOffensiveSpell(1341, 1));
		_offensiveSpells.add(new OOOffensiveSpell(1343, 2));
		_offensiveSpells.add(new OOOffensiveSpell(1234, 3));
		_offensiveSpells.add(new OOOffensiveSpell(1239, 4));
