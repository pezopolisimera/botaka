 ...
 *
 */
public class AArchmageAI extends CCombatAI
{
	public AArchmageAI(FFakePlayer character)
	{
		super(character);		
	}
	...
	protected List<OOffensiveSpell> getOffensiveSpells()
	{
		...
		_offensiveSpells.add(new OOffensiveSpell(1230, 1));
		_offensiveSpells.add(new OOffensiveSpell(1339, 1));	
